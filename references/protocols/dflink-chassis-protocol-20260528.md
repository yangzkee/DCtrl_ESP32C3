...
| Motion_Velocity | 三轴速度控制；Vx/Vy 为平动速度，Vz 为角速度。 - Payload 为 `Vx, Vy, Vz` 三个 F32。 - `Vx/Vy` 单位为 m/s，`Vz` 单位为 rad/s。 Payload 为 Vx, Vy, Vz 三个 F32。 Vx/Vy 单位为 m/s， Vz 单位为 rad/s。 | 0x02 | 0x62 | 12 | [1] Vx: F32 / m/s；[2] Vy: F32 / m/s；[3] Vz: F32 / rad/s | 公开 |
